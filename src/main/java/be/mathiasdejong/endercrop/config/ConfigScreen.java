...
public class ConfigScreen {
  ...
  private static final ResourceLocation BACKGROUND =
      ResourceLocation.fromNamespaceAndPath(
          Reference.MOD_ID, "textures/block/tilled_end_stone_dry.png");
  ...
  public static Screen getConfigScreen(Screen parent) {
    ...
    Lists.newArrayList(
            ConfigValueToClothEntry.fromDouble(
                builder, EnderCropConfiguration.tilledSoilMultiplier),
            ...
            ConfigValueToClothEntry.fromBoolean(
                builder, EnderCropConfiguration.endstoneNeedsUnbreaking))
