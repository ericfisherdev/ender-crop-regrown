...
public final class ModItems {
  ...
  public static final RegistrySupplier<Item> ENDER_SEEDS =
      ITEMS.register(Reference.Items.SEEDS, EnderSeedsItem::new);

  public static final RegistrySupplier<BlockItem> TILLED_END_STONE =
      ITEMS.register(
          Reference.Blocks.TILLED_END_STONE,
          () ->
              new BlockItem(
                  ModBlocks.TILLED_END_STONE.get(),
